...
function resultados(){
    if(valor1.value == "" || valor2.value == ""){
        ...
        resultado.innerHTML += "O resultado de " + valor1.value + " + " + valor2.value + " = "  + soma + "\n"
        resultado.innerHTML += "O resultado de " + valor1.value + " - " + valor2.value + " = "  + subtracao + "\n";
        resultado.innerHTML += "O resultado de " + valor1.value + " x " + valor2.value + " = "  + multiplicacao + "\n";
        resultado.innerHTML += "O resultado de " + valor1.value + " / " + valor2.value + " = "  +  divisao + "\n"
        resultado.innerHTML += "O resultado de " + valor1.value + " ** " + valor2.value + " = "  +  potencia + "\n"
